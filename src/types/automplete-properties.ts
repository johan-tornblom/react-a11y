/**
 * Enumeration of all the different options available as options for the
 * autocomplete property of the input, select and text area types.
 *
 * Source:
...
export enum AutoCompleteProperties {
  ...
  PHONE_NATIONAL = 'tel-national',
  /**
   * The area code, with any country-internal prefix applied if appropriate.
   */
  PHONE_AREA_CODE = 'tel-area-code',
  /**
  ...
  INSTANT_MESSAGING = 'impp',
  /**
   * A URL, such as a home page or company web site address as appropriate given
